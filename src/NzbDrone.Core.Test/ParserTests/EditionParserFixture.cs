...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class EditionParserFixture : CoreTest
    {
        ...
        [TestCase("Movie (1968) Director's Cut .mkv", "Director's Cut")]
        [TestCase("Movie 1968 (Extended Directors Cut FanEdit)", "Extended Directors Cut FanEdit")]
        ...
        [TestCase("Movie (Extended Directors Cut FanEdit) 1968 Bluray 1080p", "Extended Directors Cut FanEdit")]
